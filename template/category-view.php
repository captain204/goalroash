<?php include("includes/header.php");?>
	 <div class="col-md-5 col-md-offset-3">
			...
			<?php endif;?>
			  	<a href="laliga.php?page=<?php echo $next;?>"><button class="btn btn-primary pull-right">Next</button></a>
			 <?php if($previous):?>
			  <a href="laliga.php?page=<?php echo $previous;?>"><button class="btn btn-primary pull-right">Previous</button></a>
			 <?php endif;?>	
	</div>
