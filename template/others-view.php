<?php include("includes/header.php");?>
	 <div class="col-md-5 col-md-offset-3">
			...
			<?php endif;?>
			  	<a href="others.php?page=<?php echo $next;?>"><button class="btn btn-primary pull-right">Next</button></a>
			  	
			  	<a href="others.php?page=<?php echo $previous;?>"><button class="btn btn-primary pull-right">Previous</button></a>	
	</div>
