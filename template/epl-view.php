<?php include("includes/header.php");?>
	 <div class="col-md-5 col-md-offset-3">
			...
			<?php endif;?>
			  	<a href="epl.php?page=<?php echo $next;?>"><button class="btn btn-primary pull-right">Next</button></a>
			  <?php if($previous):?> 	
			  	<a href="epl.php?page=<?php echo $previous;?>"><button class="btn btn-primary pull-left">Previous</button></a>	
			  <?php endif;?>
	</div>
